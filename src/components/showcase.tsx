...
const tracks = [
  ...
  { id: "token", name: "Agent Token Tooling" },
...
const TabCorners = () => (
  <>
    <div className="absolute -left-1 -top-1">
      <Image src={cornerAbstract} alt="Corner" className="w-1 h-1" />
    </div>
...
const TrackNavigation = ({ activeTrack, onTrackSelect }: any) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      ...
      <div className="md:hidden w-full flex justify-center" ref={dropdownRef}>
        <button
        ...
        {isOpen && (
          <div className="absolute z-50 w-[240px] mt-12 bg-[#1E1E1E] border-2 border-[#353637] shadow-xl">
            <TabCorners />
      ...
      {/* Desktop Tabs - Only visible on medium and larger screens */}
      <div className="hidden md:flex flex-wrap justify-center gap-4 px-4 mx-16 w-full">
        {tracks.map((track) => (
          <button
            key={track.id}
